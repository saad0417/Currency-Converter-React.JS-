...
function App() {
  ...
  return (
    <div
      className="w-full h-screen bg-center flex flex-wrap justify-center items-center bg-cover bg-no-repeat"
      style={{
        backgroundImage:
          "url('https://images.pexels.com/photos/33913600/pexels-photo-33913600.jpeg')",
      }}
    >
